...
const CoffeeData = [
  {
    ...
    name: 'Americano',
    description:
      "The Americano is another popular type of coffee drink, and it's very easy to make! It's just expresso with hot water dripping over it. The name came about during World War II when European baristas added water to their expresso drinks for the American soldiers stationed there. The resulting drink had a smoother, less concentrated flavour than expresso and thus the Americano was born.",
  ...
  },
  {
    ...
    name: 'Cappucchino',
    description:
      'Cappuccinos are a classic Italian type of coffee drink made of expresso, steamed milk, and thick foam in equal parts. The name comes from the resemblance to the hoods worn by Capuchin monks. Making cappuccino is relatively easy and can be done at home too if you know how to make expresso.',
    roasted: 'Medium Roasted',
  ...
  },
  {
    ...
    name: 'Expresso',
    description:
      'Expresso is made by forcing nearly boiling water through finely-ground coffee beans, which results in a concentrated, syrup-like coffee drink. This is the base for many Italian beverages in coffee shops. When compared to regular brewed coffee, expresso is much stronger than the other types of coffee drinks. Expressos are enjoyed in shots where a single shot is one ounce and a long (single and double) shot is two ounces in amount, respectively.',
    roasted: 'Medium Roasted',
    imagelink_square: require('../assets/coffee_assets/expresso/square/expresso_pic_1_square.png'),
    imagelink_portrait: require('../assets/coffee_assets/expresso/portrait/expresso_pic_1_portrait.png'),
    ingredients: 'Milk',
    special_ingredient: 'With Steamed Milk',
    prices: [
      { size: 'S', price: '1.38', currency: '$' },
  ...
  },
  {
    ...
    description:
      'Expresso is made by forcing nearly boiling water through finely-ground coffee beans, which results in a concentrated, syrup-like coffee drink. This is the base for many Italian beverages in coffee shops. When compared to regular brewed coffee, expresso is much stronger than the other types of coffee drinks. Expressos are enjoyed in shots where a single shot is one ounce and a long (single and double) shot is two ounces in amount, respectively.',
    roasted: 'Medium Roasted',
    imagelink_square: require('../assets/coffee_assets/expresso/square/expresso_pic_2_square.png'),
    imagelink_portrait: require('../assets/coffee_assets/expresso/portrait/expresso_pic_2_portrait.png'),
    ingredients: 'Milk',
    special_ingredient: 'With Steamed Milk',
    prices: [
      { size: 'S', price: '1.38', currency: '$' },
  ...
  },
  {
    ...
    description:
      'Expresso is made by forcing nearly boiling water through finely-ground coffee beans, which results in a concentrated, syrup-like coffee drink. This is the base for many Italian beverages in coffee shops. When compared to regular brewed coffee, expresso is much stronger than the other types of coffee drinks. Expressos are enjoyed in shots where a single shot is one ounce and a long (single and double) shot is two ounces in amount, respectively.',
    roasted: 'Medium Roasted',
    imagelink_square: require('../assets/coffee_assets/expresso/square/expresso_pic_3_square.png'),
    imagelink_portrait: require('../assets/coffee_assets/expresso/portrait/expresso_pic_3_portrait.png'),
    ingredients: 'Milk',
    special_ingredient: 'With Steamed Milk',
    prices: [
      { size: 'S', price: '1.38', currency: '$' },
  ...
  },
  {
    ...
    name: 'Latte',
    description:
      'A latte is an expresso with steamed milk and a dollop of milk foam on top. This beverage is more prevalent in America than other coffee drinks like cappuccinos because it contains less foam, making it smoother and gentler for those with sensitive palettes. And if you want to spice up your latte, add some flavouring syrup. To make an iced version of this drink, simply pour expresso and steamed milk over ice cubes.',
    roasted: 'Medium Roasted',
  ...
  },
  {
    ...
    name: 'Macchiato',
    description:
      'The word "macchiato" means spotted, so a macchiato expresso is an expresso with a splash of milk. Most coffee shops will top off this type of coffee drink with some foamed milk instead of just steamed milk for what\'s known as a traditional macchiato. ',
    roasted: 'Medium Roasted',
